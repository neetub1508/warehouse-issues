...
| `P2-09` | `V511064` | Seed row, no DDL: the `REVERSAL` reason `DESTAGED` that `V510041` seeds - an early, uncommitted draft of `V510041` was applied locally without it, and `V510041` is frozen, so the committed end state is forward-seeded, guarded so it is a no-op wherever `V510041` ran in full. Claimed from the warehouse grid band `V511060`-`V511139` (`P2-29` now starts at `V511065`), 2026-09-18 | v1 |
