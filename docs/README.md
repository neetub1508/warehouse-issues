...
| 7 | **[SCENARIO-CATALOGUE.md](SCENARIO-CATALOGUE.md)** | QA, reviewers | **330 scenarios** in Given/When/Then. **These are the acceptance criteria** — a task issue names its subset, and "done" means walked in a running application |
