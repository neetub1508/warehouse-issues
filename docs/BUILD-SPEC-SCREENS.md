...
**v2 — a *Translations* tab** (`P5-28`, `FR-469`): per-locale names over `whb_registry_translations`
...
| `wh_trade_portal_users:view` · `:create` · `:edit` · `:delete` · `:export` | the new resource | WS-240 | `P5-25` · `V511209` + `V511239` |
| `wh_approval_levels:view` · `:create` · `:edit` · `:delete` · `:export` | the new resource | WS-241 | `P5-27` · `V511210` + `V511240` |
